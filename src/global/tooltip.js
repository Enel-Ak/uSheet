...
const tooltip = {
  info: function(title, content) {
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        content: content,
        botton:
          '<button class="btn btn-default luckysheet-model-close-btn el-button">&nbsp;&nbsp;' +
          locale_button.close +
          "&nbsp;&nbsp;</button>",
  ...
  confirm: function(title, content, func1, func2, name1, name2) {
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        content: content,
        botton:
          '<button class="btn btn-primary luckysheet-model-conform-btn">&nbsp;&nbsp;' +
          name1 +
          '&nbsp;&nbsp;</button><button class="btn btn-default luckysheet-model-cancel-btn">&nbsp;&nbsp;' +
          name2 +
          "&nbsp;&nbsp;</button>",
      })
    );
  ...
  screenshot: function(title, content, imgurl) {
    ...
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        content: content,
        botton:
          '<a style="text-decoration:none;color:#fff;" class="download btn btn-primary luckysheet-model-conform-btn">&nbsp;&nbsp;' +
  ...
  chartPointConfig: function(id, savefunc1, closefunc2) {
    $("body").append(
      replaceHtml(modelHTML, {
        ...
        botton:
          '<button class="btn btn-danger luckysheet-model-save-btn">&nbsp;&nbsp;保存设置&nbsp;&nbsp;</button><button class="btn btn-default luckysheet-model-close-btn">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>',
  ...
  popover: function(content, position, close, style, btntxt, exitsFuc) {
    ...
    let htmldiv =
      '<div id="luckysheetpopover" class="luckysheetpopover"><div class="luckysheetpopover-content">' +
      locale_paint.start +
      '</div><div class="luckysheetpopover-btn">' +
      btntxt +
      "</div></div>";
    ...
    if (style == "white") {
      ...
      pcss.color = "#000";
      $("#luckysheetpopover .luckysheetpopover-btn").css({
        border: "1px solid #000",
      });
    }

    setTimeout(function() {
      $("#luckysheetpopover .luckysheetpopover-content").css({
        "margin-left":
