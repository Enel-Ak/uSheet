...
export function rowColumnOperationInitial() {
  ...
  $("#luckysheet-rows-h")
    ...
    .mouseup(function(event) {
      if (event.which == 3) {
        ...
        $("#luckysheet-rightclick-menu .luckysheet-cols-rows-shift-word").text(
          locale().rightclick.row
        );
        $("#luckysheet-rightclick-menu .luckysheet-cols-rows-shift-size").text(
          locale().rightclick.height
        );
        $("#luckysheet-rightclick-menu .luckysheet-cols-rows-shift-left").text(
          locale().rightclick.top
        );
        $("#luckysheet-rightclick-menu .luckysheet-cols-rows-shift-right").text(
  ...
  $("#luckysheet-cols-h-c")
    ...
    .mousemove(function(event) {
      ...
      if (
        Store.luckysheet_cols_menu_status ||
    ...
    .mouseup(function(event) {
      if (event.which == 3) {
        ...
        $$(
          "#luckysheet-top-left-add-selected"
        ).style.display = cellRightClickConfig.insertColumn ? "block" : "none";
        $$(
          "#luckysheet-bottom-right-add-selected"
        ).style.display = cellRightClickConfig.insertColumn ? "block" : "none";
        $$(
          "#luckysheet-del-selected"
        ).style.display = cellRightClickConfig.deleteColumn ? "block" : "none";
        $$(
          "#luckysheet-hide-selected"
  ...
  $("#luckysheet-cols-menu-btn").click(function(event) {
    ...
    $$("#luckysheet-cols-rows-add .luckysheet-menuseparator").style.display =
      "block";
    $$("#luckysheet-cols-rows-shift .luckysheet-menuseparator").style.display =
      "block";
    ...
    if (
      ...
      if (
        ...
        $$(
          "#luckysheet-cols-rows-shift .luckysheet-menuseparator"
        ).style.display = "none";
      }
    }
  ...
  $("#luckysheet-top-left-add-selected").click(function(event) {
    ...
    let st_index =
      Store.luckysheet_select_save[0][Store.luckysheetRightHeadClickIs][0];
    ...
    if (
      !method.createHookFunction(
        ...
        value,
        "lefttop",
        Store.luckysheetRightHeadClickIs
      )
    ) {
      return;
    }
  ...
  $("#luckysheet-bottom-right-add-selected").click(function(event) {
    ...
    let st_index =
      Store.luckysheet_select_save[0][Store.luckysheetRightHeadClickIs][1];
  ...
  //删除选中行列
  $("#luckysheet-del-selected, #luckysheet-del-selected_t").click(function(
    event
  ) {
    $("#luckysheet-rightclick-menu").hide();
    luckysheetContainerFocus();
  ...
  $("#luckysheet-delRows").click(function(event) {
    ...
    if (
      !method.createHookFunction("rowDeleteBefore", st_index, ed_index, "row")
    ) {
      return;
    }
...
function luckysheetcolsdbclick() {
  ...
  let dataset_row_ed = luckysheet_searcharray(
